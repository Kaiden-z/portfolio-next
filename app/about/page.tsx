...
export default function About() {
    return (
        <main>
            ...
            <section>
                <p>
                    Video games have been a passion of mine since I played my first game, Team Fortress 2, on the family computer. 
                    Some of my favorite games of all time include the Monster Hunter series, Street Fighter series, and Baldur's Gate 3. 
                    ...
                    interact, communicate, and socialize, as something that has been particularly meaningful to me as someone who has experienced physical limitations.
                </p>
                <p>
            ...
            <section>
                <h2>Check out some of my past works here!</h2>
            </section>
        </main>
    )
}